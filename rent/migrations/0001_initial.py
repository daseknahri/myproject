    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('pickup_time', models.TimeField(default=datetime.time(22, 56, 41, 152621), verbose_name='Pickup Time')),
                ('dropoff_time', models.TimeField(default=datetime.time(22, 56, 41, 152621), verbose_name='Dropoff Time')),
